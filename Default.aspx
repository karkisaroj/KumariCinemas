...
<head runat="server">
    ...
    <style>
        ...
        .kc-brand{color:#1e293b!important;font-weight:700;font-size:1.15rem}.kc-brand span{color:#4f46e5}
        ...
        .hero{background:rgba(148,163,184,.15);backdrop-filter:blur(16px);-webkit-backdrop-filter:blur(16px);border:1px solid #e2e8f0;border-radius:16px;padding:48px 40px;color:#1e293b;margin-bottom:28px;position:relative;overflow:hidden}
        .hero h1{font-size:2rem;font-weight:800;margin-bottom:8px;color:#1e293b}
        .hero p{color:#64748b;font-size:1rem;margin-bottom:24px}
        .hero-btn{background-color:#4f46e5;color:#fff;border:none;border-radius:8px;padding:11px 28px;font-weight:700;font-size:.9rem;text-decoration:none;display:inline-block}
        .hero-btn:hover{background-color:#4338ca;color:#fff}
        .stat-card{background:#fff;border:1px solid #e2e8f0;border-radius:12px;padding:24px;box-shadow:0 1px 3px rgba(0,0,0,.04);display:flex;align-items:center;gap:18px;transition:transform .2s,box-shadow .2s;text-decoration:none;color:inherit}
        .stat-card:hover{transform:translateY(-3px);box-shadow:0 4px 16px rgba(79,70,229,.1);color:inherit}
        ...
        .stat-label{font-size:.78rem;color:#94a3b8;font-weight:600;text-transform:uppercase;letter-spacing:.4px}
        .stat-value{font-size:1.9rem;font-weight:800;color:#1e293b;line-height:1.1}
        .section-title{font-size:1.05rem;font-weight:700;color:#1e293b;margin-bottom:16px}
        .quick-card{background:#fff;border:1px solid #e2e8f0;border-radius:12px;padding:20px 18px;box-shadow:0 1px 3px rgba(0,0,0,.04);text-align:center;text-decoration:none;color:#1e293b;transition:transform .2s,box-shadow .2s;display:block}
        .quick-card:hover{transform:translateY(-3px);box-shadow:0 4px 16px rgba(79,70,229,.1);color:#1e293b}
        .quick-card i{font-size:1.8rem;display:block;margin-bottom:8px}
        .quick-card span{font-size:.82rem;font-weight:600}
        .page-card{background:#fff;border:1px solid #e2e8f0;border-radius:12px;box-shadow:0 1px 3px rgba(0,0,0,.04);padding:24px}
        .table thead th{background-color:#4f46e5;color:#fff;font-size:.74rem;text-transform:uppercase;letter-spacing:.5px;border:none;padding:12px 14px}
        .table td{vertical-align:middle;font-size:.87rem;padding:11px 14px}
        .badge-booked{background:#ecfdf5;color:#059669;padding:3px 10px;border-radius:20px;font-size:.75rem;font-weight:600}
...
<div class="container-fluid px-4 py-4">
    ...
    <div class="row g-3 mb-4">
        ...
        <div class="col-6 col-md-4 col-lg-2">
            <a href="Movies.aspx" class="stat-card">
                <div class="stat-icon" style="background:#fff7ed"><i class="bi bi-film" style="color:#ea580c"></i></div>
        ...
        <div class="col-6 col-md-4 col-lg-2">
            <a href="Theaters.aspx" class="stat-card">
                <div class="stat-icon" style="background:#ecfdf5"><i class="bi bi-building" style="color:#059669"></i></div>
        ...
        <div class="col-6 col-md-4 col-lg-2">
            <a href="Halls.aspx" class="stat-card">
                <div class="stat-icon" style="background:#fefce8"><i class="bi bi-door-open" style="color:#ca8a04"></i></div>
        ...
        <div class="col-6 col-md-4 col-lg-2">
            <a href="Showtimes.aspx" class="stat-card">
                <div class="stat-icon" style="background:#eef2ff"><i class="bi bi-calendar3" style="color:#4f46e5"></i></div>
        ...
        <div class="col-6 col-md-4 col-lg-2">
            <a href="Tickets.aspx" class="stat-card">
                <div class="stat-icon" style="background:#fef2f2"><i class="bi bi-ticket-perforated" style="color:#dc2626"></i></div>
    ...
    <div class="mb-4">
        ...
        <div class="row g-3">
            <div class="col-4 col-md-2"><a href="Customers.aspx" class="quick-card"><i class="bi bi-people-fill" style="color:#7c3aed"></i><span>Customers</span></a></div>
            <div class="col-4 col-md-2"><a href="Movies.aspx" class="quick-card"><i class="bi bi-film" style="color:#ea580c"></i><span>Movies</span></a></div>
            <div class="col-4 col-md-2"><a href="Theaters.aspx" class="quick-card"><i class="bi bi-building" style="color:#059669"></i><span>Theaters</span></a></div>
            <div class="col-4 col-md-2"><a href="Halls.aspx" class="quick-card"><i class="bi bi-door-open" style="color:#ca8a04"></i><span>Halls</span></a></div>
            <div class="col-4 col-md-2"><a href="Showtimes.aspx" class="quick-card"><i class="bi bi-calendar3" style="color:#4f46e5"></i><span>Showtimes</span></a></div>
            <div class="col-4 col-md-2"><a href="Tickets.aspx" class="quick-card"><i class="bi bi-ticket-perforated" style="color:#dc2626"></i><span>Tickets</span></a></div>
        </div>
    </div>
</div>
</form>
